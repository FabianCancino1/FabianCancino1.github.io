...
var largo = localStorage.getItem('largoPelo')
...
document.getElementById('subtitulo1').innerHTML = "El resultado de tu test arrojó que tu pelo es " + tipoPelo + ", " + hebras + ", " + cuantoPelo + ", "+ largo + ", " + "<strong>" + porosidad + "</strong>" + ", cuero cabelludo " + cueroc + " " + ultima + ".\n¡Esta información es muy útil para cuando quieras probar nuevos productos puedas elegir los correctos para ti! 🤗"
document.getElementById('subtitulo2').innerHTML ="A continuación te dejamos lo que te recomendamos nosotras de acuerdo a tus caracteristicas. Esperamos que el quiz te haya sido de mucha ayuda. ¡¡Un abrazo!! 🧡🧡🧡"
//Cartas
var stringFinal = ""
//tipo pelo3 check
